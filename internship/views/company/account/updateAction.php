<?php
    ...
    function update()
    {
        global $id, $name, $owner, $profile, $phone, $cEmail, $address, $lEmail, $password, $type;
        ...
        $results = $contr->update($id, $name, $owner, $profile, $phone, $cEmail, $address, $lEmail, $password, $type);
        if($results) {
           echo $results;
        }else{
